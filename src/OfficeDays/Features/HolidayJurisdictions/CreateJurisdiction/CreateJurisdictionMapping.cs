...
{
    public static CreateJurisdictionResponse ToViewModel(this HolidayJurisdiction jurisdiction) => new CreateJurisdictionResponse(jurisdiction.Code, jurisdiction.Name);
}
